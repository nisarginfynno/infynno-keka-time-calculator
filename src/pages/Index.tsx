        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <Card className="bg-card shadow-lg">
              ...
              <CardContent className="space-y-4">
                <Textarea
                  ...
                  className="min-h-[220px] font-mono text-sm bg-secondary/50 border-border focus:border-accent focus:ring-accent"
                />
          ...
          <div className="lg:col-span-7">
            {result ? (
              ...
              <Card className="bg-card/50 border-dashed border-2 border-muted">
                <CardContent className="py-12 text-center">
                  <Calculator className="w-12 h-12 text-muted-foreground/50 mx-auto mb-4" />
                  <p className="text-muted-foreground">
                    Paste your punch log to see calculated results
                  </p>
                </CardContent>
              </Card>
            )}
